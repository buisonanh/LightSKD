...
from backbone.resnet_pretrained import resnet50pretrained
...
def get_model(args):
    if args.model == "ResNet18":
        ...
        return ResNet50(num_class=8631, include_top=False) #args.num_classes)
    ...
    elif args.model == "ResNet50Pretrained":
        model = ResNet50(num_class=8631, include_top=False)
        return model
